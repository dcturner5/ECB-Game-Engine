...
public class StoneTower extends Structure {
	
	public static final String NAME = "Stone Tower";
	...
	public static final Model MODEL = new Model(WIDTH, HEIGHT, new TextureArray("res/structures/tower.png", 5), new TextureArray("res/structures/tower_normal.png", 5));
	public static final Model PREVIEW_MODEL = new Model(WIDTH, HEIGHT, new Texture("res/structures/tower_preview.png"));
	...
	public static final Vector3f ENTER_DOOR_POSITION = new Vector3f(1 * Tile.WIDTH, 5 * Tile.HEIGHT, .00001f);
	public static final Vector2f ENTER_DOOR_PLACEMENT = new Vector2f(0, Tile.HEIGHT);
	public static final Vector3f EXIT_DOOR_POSITION = new Vector3f(1 * Tile.WIDTH, 1 * Tile.HEIGHT, .00001f);
	public static final Vector2f EXIT_DOOR_PLACEMENT = new Vector2f();
	
	private int[] sideIndices = new int[] {1, 1, 1, 1};

	public StoneTower(Vector3f position, Game game) {
		super(Structure.STONE_TOWER, position, WIDTH, HEIGHT, LAYER, MODEL, game);
		setOverlay(OVERLAY_MODEL);
		setDoorPositions(ENTER_DOOR_POSITION, ENTER_DOOR_PLACEMENT, EXIT_DOOR_POSITION, EXIT_DOOR_PLACEMENT);
	}
