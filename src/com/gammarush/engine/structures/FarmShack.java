...
public class FarmShack extends Structure {

	public static final String NAME = "Farm";
	public static final int WIDTH = Tile.WIDTH * 6;
	...
	public static final Model MODEL = new Model(WIDTH, HEIGHT, new TextureArray("res/structures/barn.png", 1), new TextureArray("res/structures/barn_normal.png", 1));
	public static final Model PREVIEW_MODEL = new Model(WIDTH, HEIGHT, new Texture("res/structures/barn_preview.png"));
	
	private int[] sideIndices = new int[] {1, 1, 1, 1};

	public FarmShack(Vector3f position, Game game) {
		super(Structure.FARM_SHACK, position, WIDTH, HEIGHT, LAYER, MODEL, game);
	}
