...
public class UIButton extends UIComponent {
	...
	public void render(Renderer renderer) {
		...
		renderer.font.drawString(string, 
				...
				scale, fontColor, new Vector4f(container.position.x, container.position.y, container.position.x + container.width, container.position.y + container.height), renderer);
		Renderer.GUI.enable();
	}
